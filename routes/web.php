...
Route::post('group/changeGroup/{idParticipant}'                 , [groupsController::class, 'changeGroup'])                 ->name('changeGroup');
...
Route::get('unificationPseudo', [participantController::class, 'unificationPseudo']);

...
<div class="card">
    <div class="card-header">
        <h3 class="my-3">Gérer les groupes</h3>
    ...
    <div class="card-body">
        <div class="pb-3 collapse" id="groups_ceationCollapse">
            <div class="card-header">
            ...
            <hr class="mx-2 text-primary"/>
        </div>
        
        <div class="pb-3 collapse show" id="groups_details_actifCollapse">
            <div class="card-header">
                <h3>Les groupes avtif(s)</h3>
            </div>
        ...
        <div class="pb-3 collapse" id="groups_details_inactifCollapse">
            <div class="card-header">
                <h3>Les groupes inactifs</h3>
            </div>
            <div class="d-flex flex-direction-row flex-wrap">
        ...
        <div class="pb-3 collapse" id="groups_composeCollapse">
            <div class="card-header">
                <h3>Composition de Groupe</h3>
            </div>
            <div class="mt-3">
